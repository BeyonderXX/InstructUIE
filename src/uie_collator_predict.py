...
@dataclass
class DataCollatorForUIE_decoder:
    ...
    def __call__(self, batch, return_tensors=None):
        ...
        if 'codegen'.lower() in self.model.config._name_or_path.lower() or 'bloomz'.lower() in self.model.config._name_or_path.lower() :
            ...
            for instance in batch:
                ...
                labels.append(task_input+label)
            ...
            # else:
            #     tokenizor_labels = self.tokenizer(
            #         labels,
            ...
            #         pad_to_multiple_of=self.pad_to_multiple_of
            #     )
            #     label_mask = tokenizor_labels["attention_mask"].bool()
            #     model_inputs["labels"] = tokenizor_labels["input_ids"].masked_fill(~label_mask, self.label_pad_token_id)
            #
