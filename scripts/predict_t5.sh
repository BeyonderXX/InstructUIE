...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_uie.py \
   ...
   --resume_from_checkpoint /workspace/InstructUIE/output/t5-200M-mult-mi \
   --model_name_or_path /root/MODELS/flan-t5-200M \
   --output_dir /workspace/InstructUIE/output/t5-200M-mult-mi \
